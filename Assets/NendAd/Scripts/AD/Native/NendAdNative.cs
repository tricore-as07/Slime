namespace NendUnityPlugin.AD.Native
{
	...
	public sealed class NendAdNative : MonoBehaviour
	{
		...
		private INativeAdClient CreateClient ()
		{
			...
			return NativeAdClientFactory.NewClient (account.iOS.spotID, account.iOS.apiKey);
			#elif UNITY_ANDROID && !UNITY_EDITOR
			return NativeAdClientFactory.NewClient (account.android.spotID, account.android.apiKey);
			#else
