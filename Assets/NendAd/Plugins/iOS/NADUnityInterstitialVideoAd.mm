...
NendIOSVideoAdPtr _CreateInterstitialVideoAd(int spotId, const char* apiKey)
{
    ...
    IOSVideoAd.interstitialVideo = [[NADInterstitialVideo alloc] initWithSpotID:spotId apiKey:NADUnityCreateNSString(apiKey)];
...
{
    NendIOSInterstitialVideoAd *IOSVideoAd = (__bridge NendIOSInterstitialVideoAd *)iOSPtr;
    return IOSVideoAd.interstitialVideo.adType;
}
...
{
    NendIOSInterstitialVideoAd *IOSVideoAd = (__bridge NendIOSInterstitialVideoAd *)iOSPtr;
    [IOSVideoAd.interstitialVideo addFallbackFullboardWithSpotID:spotId apiKey:NADUnityCreateNSString(apiKey)];
