...
namespace NendUnityPlugin.Platform.Android
{
	...
	internal class VideoMethodUtils
	{
		...
		internal static int AdType (AndroidJavaObject androidJavaObj)
		{
			return androidJavaObj.Call <int>("adVideoType");
		}
		...
		internal static void AddFallbackFullboard (AndroidJavaObject androidJavaObj, int spotId, string apiKey) {
			androidJavaObj.Call ("addFallbackFullboard", spotId, apiKey);
		}
	}
}
#endif
