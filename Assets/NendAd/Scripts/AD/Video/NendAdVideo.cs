namespace NendUnityPlugin.AD.Video
{
	...
	public abstract class NendAdVideo : IDisposable
	{
		...
		public enum NendVideoAdType : int
		{
			Unknown,
			Normal,
			Playable
		...
		/// Check ad type.
		/// </summary>
		public NendVideoAdType AdType
		{
			get {
				return (NendVideoAdType)Enum.ToObject(typeof(NendVideoAdType), AdTypeInternal ());
			}
		}
		...
		internal abstract int AdTypeInternal ();
