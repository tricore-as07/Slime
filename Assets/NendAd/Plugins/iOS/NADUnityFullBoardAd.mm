...
NendIOSFullBoardAdPtr _CreateFullBoardAd(int spotId, const char* apiKey)
{
    NendIOSFullBoardAd *iOSFullBoardAd = [[NendIOSFullBoardAd alloc] init];
    iOSFullBoardAd.loader = [[NADFullBoardLoader alloc] initWithSpotID:spotId apiKey:NADUnityCreateNSString(apiKey)];
