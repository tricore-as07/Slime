namespace NendUnityPlugin.AD.Native
{
	...
	public class NativeAdClientFactory
	{
		...
		public static INativeAdClient NewClient (int spotId, string apiKey)
		{
			#if !UNITY_EDITOR && UNITY_IOS
			return new NendUnityPlugin.Platform.iOS.IOSNativeAdClient(spotId, apiKey);
			#elif !UNITY_EDITOR && UNITY_ANDROID
			return new NendUnityPlugin.Platform.Android.AndroidNativeAdClient(spotId, apiKey);
			#else
			return null;
			#endif
		}
        ...
        {
            return NewClient(int.Parse (spotId), apiKey);
        }
