...
namespace NendUnityPlugin.Platform.iOS
{
	...
	internal class IOSNativeAdClient : NativeAdClient
	{
		...
		internal IOSNativeAdClient (int spotId, string apiKey) : base ()
		{
			m_ClientPtr = _CreateNativeAdClient (spotId, apiKey);
		}
		...
		private static extern IntPtr _CreateNativeAdClient (int spotId, string apiKey);
