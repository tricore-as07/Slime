...
namespace NendUnityPlugin.Platform.iOS
{
	...
	internal class IOSRewardedVideoAd : NendAdRewardedVideo
	{
		...
		internal IOSRewardedVideoAd (int spotId, string apiKey) : base ()
		{
		...
		{
			return _AdTypeRewarded (m_iOSRewardedVideoAdPtr);
		}
		...
		private static extern IntPtr _CreateRewardedVideoAd (int spotId, string apiKey);

		[DllImport ("__Internal")]
		private static extern int _AdTypeRewarded (IntPtr iOSVideoPtr);
